...
def cmd_encode(args: argparse.Namespace) -> None:
    ...
    from spine.tools import encode_file, load_model_from_checkpoint
...
def cmd_recon(args: argparse.Namespace) -> None:
    from spine.tools import load_model_from_checkpoint, reconstruct_file
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_encode.add_argument("--checkpoint", required=True)
    ...
    p_decode.add_argument("--checkpoint", required=True)
    ...
    p_recon.add_argument("--checkpoint", required=True)
